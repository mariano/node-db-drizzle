...
v8::Persistent<v8::FunctionTemplate> node_db_drizzle::Query::constructorTemplate;

void node_db_drizzle::Query::Init(v8::Handle<v8::Object> target) {
...
v8::Handle<v8::Value> node_db_drizzle::Query::New(const v8::Arguments& args) {
    v8::HandleScope scope;

    node_db_drizzle::Query* query = new node_db_drizzle::Query();
    if (query == NULL) {
